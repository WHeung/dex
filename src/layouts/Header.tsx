    ...
    <header className='bg-yellow dark:bg-gray-800 shadow-md'>
      <div className='container mx-auto flex justify-between items-center py-4 px-6'>
        ...
        <div className='flex gap-10'>
          ...
          <button onClick={toggleTheme} className='px-2 py-1 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded'>
            {isDarkMode ? (
        ...
        <nav className='hidden md:flex space-x-24'>
          ...
          <Link href='/swap' className='text-gray-600 dark:text-gray-300 hover:text-blue-600'>
            Swap
          </Link>
          <Link href='/history' className='text-gray-600 dark:text-gray-300 hover:text-blue-600'>
            History
          </Link>
        </nav>
      </div>
      ...
      <nav className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden bg-yellow dark:bg-gray-800 transition-all duration-300 ease-in-out`}>
        <ul className='flex flex-col space-y-2 p-4'>
          <li>
            <Link href='/' className='block text-gray-600 dark:text-gray-300 hover:text-blue-600'>
              Home
            </Link>
          </li>
          <li>
            <Link href='/swap' className='block text-gray-600 dark:text-gray-300 hover:text-blue-600'>
              Swap
            </Link>
          </li>
          <li>
            <Link href='/history' className='block text-gray-600 dark:text-gray-300 hover:text-blue-600'>
              History
            </Link>
          </li>
        </ul>
